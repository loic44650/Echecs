...
std::vector<Coord> MouvementVertical::mouvementPossible(Coord dep, Echiquier *e, char col, bool posInit) 
{
   ...
   return tousLesMouvements;
       ...
       * @complexité
      **/
bool MouvementVertical::makeMove(Coord &dep, Coord &but, Echiquier *e, bool posInit)
{
   ...
   return false;
       ...
       * @complexité
      **/
bool MouvementVertical::makeAttack(Coord &dep, Coord &but, Echiquier *e, bool posInit) 
{
   if (peutAllerEn(dep,but,e)) 
   {
